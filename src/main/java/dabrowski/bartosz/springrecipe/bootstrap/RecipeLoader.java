package dabrowski.bartosz.springrecipe.bootstrap;

import dabrowski.bartosz.springrecipe.domain.*;
import dabrowski.bartosz.springrecipe.repositories.CategoryRepository;
...
public class RecipeLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> prepareRecipes() {
        return List.of(prepareGuacamoleRecipe(), prepareTacoRecipe());
    }

    private Recipe prepareTacoRecipe() {
        UnitOfMeasure eachUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Each")
                .orElseThrow(() -> new RuntimeException("Not found"));
        UnitOfMeasure tableSpoonUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Tablespoon")
                .orElseThrow(() -> new RuntimeException("Not found"));
        UnitOfMeasure teaSpoonUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Teaspoon")
                .orElseThrow(() -> new RuntimeException("Not found"));
        UnitOfMeasure dashUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Dash")
                .orElseThrow(() -> new RuntimeException("Not found"));
        UnitOfMeasure pintUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Pint")
                .orElseThrow(() -> new RuntimeException("Not found"));
        UnitOfMeasure cupsUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Cup")
                .orElseThrow(() -> new RuntimeException("Not found"));
        Category americanCategory = categoryRepository.findCategoriesByDescription("American")
                .orElseThrow(() -> new RuntimeException("Not found"));
        Category mexicanCategory = categoryRepository.findCategoriesByDescription("Mexican")
                .orElseThrow(() -> new RuntimeException("Not found"));
    ...
    private Recipe prepareGuacamoleRecipe() {
        UnitOfMeasure eachUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Each")
                .orElseThrow(() -> new RuntimeException("Not found"));
        UnitOfMeasure tableSpoonUom = unitOfMeasureRepository.findUnitOfMeasuresByDescription("Tablespoon")
                .orElseThrow(() -> new RuntimeException("Not found"));
